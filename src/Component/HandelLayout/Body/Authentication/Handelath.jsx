...
import lottievedio from '../../../../assets/sign-up.mp4'
    ...
    return (
        <div>
            <div className='relative w-full hidden md:block'>
                <button onClick={backHome} className={`absolute h-[52px] z-20 flex items-center  justify-center  text-sm ml-1  top-[2%]  text-black border-3 border-lime-500 hover:border-lime-400 font-bold px-1 py-1 bg-white  rounded-md hover:bg-lime-600`}>
                ...
                <div className="  flex w-[100%]">
                    <div className={`flex w-full h-screen `}>
                        <div className={`flex w-full h-screen `}>
                            ...
                            <div className={`transition-transform duration-1000 ease-in-out ${mobileSize?"":"animate__animated animate__zoomIn"} ${active ? "hidden" : "block"} ${isSignup ? "-translate-x-[100%] " : ""
                                } w-1/2 h-full flex justify-center items-center `}>
                                <Lottie className='w-full h-full' animationData={lottiAnimation} />
                            </div>
                            <div className={`transition-transform duration-1000 ease-in-out ${mobileSize?"":"animate__animated animate__zoomIn"} ${active ? "block" : "hidden"} ${isSignup ? "-translate-x-[100%] " : ""
                                } w-1/2 h-full flex  justify-center items-center `}>
                                <video className='w-full h-full' src={lottievedio} autoPlay loop muted />
                            </div>
                        </div>
                    </div>
                </div>
